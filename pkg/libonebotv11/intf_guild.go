...
func MakeChannelMessageEvent(time time.Time, messageID int32, message Message, alt_message string, guildId string, channelID string, userID string) ChannelMessageEvent {
	return ChannelMessageEvent{
		MessageEvent: MakeMessageEvent("channel", messageID, message, alt_message),
		GuildID:      guildId,
		ChannelID:    channelID,
		UserID:       userID,
	}
